...
-- GUI
local KavoLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/BongoCaat/THSBongo/main/THSBongoKavoUI"))()
...
getgenv().player_data["player"].OnTeleport:Connect(function(state)
    if state == Enum.TeleportState.Started then
        syn.queue_on_teleport(game:HttpGet("https://raw.githubusercontent.com/BongoCaat/THSBongo/main/THSMainBongo.lua"))
        can_teleport = false
    end
